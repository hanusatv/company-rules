...
All objects should be prefixed with `OBS_` including an underscore.
For example Object `OSB_SalesHeaderTemplate` is written in the file `OSBSalesHeaderTemplate.Table.al`.
